...
public class Singleton {
	...
	//Don't synchronized whole method only synchronized the instance creation part
	public static Singleton getInstance() {
		if (firstInstance == null) {
			...
			//Need to check null condition here also other wise it will create 2 objects
